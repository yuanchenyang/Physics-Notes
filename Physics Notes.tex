...
\newcommand{\uve}[1]{\ensuremath{\bm{\hat{#1}}}}          % Unit Vector
\newcommand{\tensor}[1]{\ensuremath{\text{\bf{#1}}}}	% Tensor
...
\newcommand{\cc}[1]{\ensuremath{#1^{\ast}}}			% Complex Conjugate
\newcommand{\pd}[2]{
\ensuremath{ \frac{\partial #1}{\partial #2} }}			% Partial Derivative
\newcommand{\operator}[1]{\ensuremath{\hat{\text{#1}}}}	% Operator
...
All such functions $f$ are the solutions to the wave equation:
	\begin{align*}
	\pd{^2 f}{x^2}=\frac{1}{v^2}\pd{^2 f}{t^2}
	\end{align*}
